...
const OurCityReport = () => {
  const [pdfUrl, setPdfUrl] = useState('/files/prefect.pdf');
  const [excelUrl, setExcelUrl] = useState('/files/prefect.xlsx');
  const [lastUpdate] = useState('06.04.2025 15:11');
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Сообщения личного кабинета Префекта</h1>
        </div>
        <div className="flex items-center gap-4">
